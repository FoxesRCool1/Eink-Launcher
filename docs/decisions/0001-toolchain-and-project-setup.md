...
| Topic | Choice | Why |
| --- | --- | --- |
| Language | Kotlin 2.4.20 | Current stable. |
...
| Screenshot tests | Roborazzi 1.74.0 on Robolectric 4.17 | The plan sets it. The tests record at 480 dp by 640 dp at xxhdpi, which is 1440 by 1920 pixels, the panel size. |
