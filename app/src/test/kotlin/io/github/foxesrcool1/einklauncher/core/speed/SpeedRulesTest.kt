...
class SpeedRulesTest {
    ...
    private companion object {
        const val PACKAGE_PATH = "io/github/foxesrcool1/einklauncher/"
    }
    ...
    fun `the first own frame of a report names the place in this app`() {
        val frames = listOf(
            ...
            "io.github.foxesrcool1.einklauncher.core.speed.SpeedWatch.report",
            "io.github.foxesrcool1.einklauncher.ui.writing.NoteEditorScreenKt.rememberNoteEditor\$saveOnTheWayOut",
            "io.github.foxesrcool1.einklauncher.HomeActivity.onPause",
        )
